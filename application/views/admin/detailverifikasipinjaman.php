      ...
      <form method="post" enctype='multipart/form-data'>
        ...
        <!--   <div class="form-group">
          ...
          <div id="step1" class="tab-pane fade ">
            ...
            <div class="form-group">
              <label>Alasan penolakan detail pinjaman</label>
              <textarea name="alasandetail" class="form-control"></textarea>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="form-group">
              <label>Alasan penolakan detail usaha</label>
              <textarea name="alasanusaha" class="form-control"></textarea>
            </div>
          </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-md-10">
                  <a href="<?= base_url() ?>admin/verifikasimember" class="btn btn-warning btn-block">Back</a>                 
                </div>
              </div>
            </div>
      </form>
