      ...
      <div class="box box-default color-palette-box">
        ...
        <div class="box-body">
          <div class="col-md-9">
            ...
            <div class="form-group">
              <label>Alasan penolakan (diisi jika data direject)</label>
              <textarea name="penolakan" class="form-control"><?= $member->alasanditolak ?></textarea>
            </div>
            <div class="form-group">
              
              <div class="row">
                <?php
              if($member->statusverifikasi!=1){
              ?>
                <div class="col-md-6">
